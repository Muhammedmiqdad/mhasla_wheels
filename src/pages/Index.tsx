...
import { Car, Bike, MapPin, Camera, ArrowRight, Star, Shield, Clock, Users, Phone, MessageCircle } from 'lucide-react';
...
const Index = () => {
  ...
  const features = [
    ...
    },
    {
      icon: Star,
      title: "Top Rated",
      description: "4.8+ customer rating"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="hero-section">
        ...
        <div className="hero-content">
          <div className="floating-element">
            <div className="w-20 h-20 bg-accent rounded-full flex items-center justify-center mx-auto mb-8">
              <Car size={40} className="text-accent-foreground" />
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center animate-slide-in-right">
            <Button 
              ...
              className="btn-accent text-accent-foreground font-semibold px-8 py-3 text-lg hover:scale-105 transition-transform"
            >
              Explore Our Fleet
        ...
        <div className="absolute top-40 right-20 w-6 h-6 bg-accent/60 rounded-full animate-float"></div>
        <div className="absolute bottom-20 left-20 w-3 h-3 bg-accent rounded-full animate-bounce-gentle"></div>
      </section>
      ...
      <section className="section-padding bg-secondary">
        <div className="max-w-6xl mx-auto container-padding">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {fleetPreview.map((vehicle, index) => (
              <div key={index} className="fleet-card">
                <div className="h-48 bg-gradient-primary rounded-t-xl flex items-center justify-center">
          ...
          <div className="text-center mt-12">
            <Button 
              onClick={() => window.location.href = '/fleet'}
              className="btn-gradient text-primary-foreground font-semibold px-8 py-3"
            >
              View Complete Fleet
              <ArrowRight size={20} className="ml-2" />
            </Button>
